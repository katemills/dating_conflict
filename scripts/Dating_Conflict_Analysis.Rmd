...
# Does gender interact with puberty at grade 8 in relation to opportunities monitoring score?
...
# Does gender interact with ethnicity in relation to opportunities monitoring score?
gender_ethnicity_oppmon<-lm(OppMonitorMean ~ Gender * Ethnicity,  data=thedata, na.action=na.omit)
anova(gender_ethnicity_oppmon) # No
...
puberty_pred_ageoldpartner<-lm(oldest ~ Puberty_3group, data=thedata %>% filter(Gender=="Female"), na.action=na.omit)
...
ageoldpartner_puberty_pred_EMAaloneBFGF<-lm(EMAaloneBFGF ~ oldest*Puberty_2group, data=thedata, na.action=na.omit)

# Check out the results
anova(oppmon_pred_EMAaloneBFGF)
summary(oppmon_pred_EMAaloneBFGF)
anova(ageoldpartner_pred_EMAaloneBFGF)
anova(ageoldpartner_puberty_pred_EMAaloneBFGF)
summary(ageoldpartner_puberty_pred_EMAaloneBFGF)
...
puberty_pred_datingconflict<-lm(DatingConflictMean ~ Puberty_2group, data=thedata, na.action=na.omit)
puberty_gender_pred_datingconflict<-lm(DatingConflictMean ~ Gender * Puberty_2group,  data=thedata, na.action=na.omit)
...
EMAaloneBFGF_pred_datingconflict<-lm(DatingConflictMean ~ EMAaloneBFGF, data=thedata, na.action=na.omit)

anova(oppmon_pred_datingconflict)
summary(oppmon_pred_datingconflict)
anova(ageoldpartner_pred_datingconflict)
anova(EMAaloneBFGF_pred_datingconflict)
```
