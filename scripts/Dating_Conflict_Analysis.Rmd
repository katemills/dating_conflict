...
# Clean oldest partner age to identify the oldest partner by grade 10 (Wave 9)
...
ggsave(plot = dating_conflict_dist_mean,file=paste(workdir,"graphs/dating_conflict_dist_mean.png",sep = ""),
       width = 6, height = 4, dpi = 300,units="in")
...
ggsave(plot = dating_conflict_dist_total,file=paste(workdir,"graphs/dating_conflict_dist_total.png",sep = ""),
       width = 6, height = 4, dpi = 300,units="in")
...
# Since we're only looking at correlations between a single time points, use regular linear regression
oppmon_pred_datcon<-lm(DatingConflictMean ~ OppMonitorMean, data=thedata, na.action=na.exclude)

# Check out the results
anova(oppmon_pred_datcon)
summary(oppmon_pred_datcon)
